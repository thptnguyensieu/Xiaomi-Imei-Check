...
namespace Xiaomi_IMEI_information
{
    partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        private void LoadCaptcha()
        {
            try
            {
                byte[] imageBytes = client.DownloadData("https://dailythuonghien.com/api/mi/captcha.php");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string getUrl = $"https://dailythuonghien.com/api/mi/api.php?imei={imeiText}&code={captchaCode}";
